...
export const textSite = [
  {
    ...
    desc: "기존의 다이슨 코리아 사이트를 리뉴얼하였습니다. 깃협업으로 프로젝트를 진행한 경험이 있습니다.// 저를 포함한 조원 4명이 진행하였으며, 저는 '디자인과 코딩(커뮤니티 전체 페이지, 제품 페이지 기능, 제품디테일 페이지 기능, 전체 페이지 디테일 및 기능 수정)'을 담당하였습니다. ",
