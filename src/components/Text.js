...
export const textSite = [
  ...
  },
  {
    ...
    desc: (
      <Text>
        🙋‍♀ 인원 : <h1>1</h1>명
        <br />
        <br /> ✅<a href="https://www.themoviedb.org/?language=ko">TMDB</a>
        사이트에서 API를 받아옴
        <br /> ✅API에 따른 컨텐츠 자동 업데이트
        <br /> ✅로딩페이지와 비동기화 구현
        <br /> ✅기존의 OTT 사이트를 분석 후, 기능 구현
        <br /> ✅미디어쿼리를 이용한 반응형 구현
        <br /> ✅Adobe XD를 사용해 디자인
      </Text>
    ),
  ...
  },
  {
    ...
    keyword: "서울식물원의 기존 사이트 리뉴얼 - 퍼블리싱",
    desc: (
      <Text>
        ...
        <br /> ✅기존 식물원과 타사이트를 분석 후, 원하는 방향으로 사이트
        퍼블리싱
      </Text>
    ),
